<%@ Page Title="Mantenimiento - Sistema Cotizacion" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="manto_cot_new.aspx.cs" Inherits="MANCAL_WEB.frm_manto.manto_cot_new"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Ingreso Cotización Mantenimiento</h1>
    ...
    <asp:UpdatePanel ID="panelCli" runat="server" UpdateMode="Conditional"><ContentTemplate>
        <table style="width: 100%;">
            ...
            <tr>
                <td>Excede Valor</td>
                <td>
                    <asp:CheckBox ID="chkExcede" runat="server" />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
                <table cellpadding="5px">
                    <tr>
                        <td>Tipo Trabajo<br />
                        <asp:DropDownList ID="cboTipoTrabajo" runat="server" Width="170px" 
                                oninit="cboTipoTrabajo_Init"><%--onchange="cambiaTrabajo();"--%>
                        </asp:DropDownList>
                        </td>
                        <td>
                            Número Parte<br />
                            <input type="text" id="txtnroparte" name="txtnroparte"/>
                            <asp:Button ID="btnBuscarEquipo" runat="server" Text="Buscar" 
                                onclick="btnBuscarEquipo_Click" />
                        </td>
                        <td>
                        </td>
                        <td><asp:Label ID="estadoTT" runat="server" Font-Bold="true" ForeColor="Red"></asp:Label></td>
                        <td class="style13"><asp:Label ID="estadoNP" runat="server" Font-Bold="true" ForeColor="Red"></asp:Label></td>
                    </tr>
                </table>
            </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional"><ContentTemplate>
        <table cellpadding="5px">
            <tr>                     
                <td>
                    Descripción<br />
                    <asp:TextBox ID="Descripcion" runat="server" Width="260px" ReadOnly="True"></asp:TextBox>
                </td>
                <td>
                    Nro Serie<br />
                    <asp:TextBox ID="NroSerie" runat="server" Width="120px"></asp:TextBox>
                </td>
                <td>
                    Cantidad<br />
                    <asp:TextBox ID="txtCantidad" runat="server" Width="60px">1</asp:TextBox>
                ...
                <td>
                    Precio Repuesto<br />
                    <asp:TextBox ID="ValorRepuesto" runat="server" Width="100px">0</asp:TextBox>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                        ErrorMessage="<b>Formato Numero Incorrecto</b><br />Favor utilize un punto para separar decimales" 
                        ControlToValidate="ValorRepuesto" Display="None" ValidationExpression="\d+(\.\d{1,2})?"></asp:RegularExpressionValidator>
                        ...
                        <asp:HiddenField ID="txtHideRpto" runat="server" />
                </td>
                <td>
                    Costo MO<br />
                    <asp:TextBox ID="ValorMO" runat="server" Width="100px" ReadOnly="True">0</asp:TextBox>
                </td>
                <td>
                    Precio MO<br />
                    <asp:TextBox ID="PrecioTipoTarifa" runat="server" Width="100px">0</asp:TextBox>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                        ErrorMessage="<b>Formato Numero Incorrecto</b><br />Favor utilize un punto para separar decimales"
                        ControlToValidate="PrecioTipoTarifa" Display="None" ValidationExpression="\d+(\.\d{1,2})?"></asp:RegularExpressionValidator>
                    <asp:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server" TargetControlID="RegularExpressionValidator3"
                        HighlightCssClass="validatorCalloutHighlight">
                    </asp:ValidatorCalloutExtender>
                        <asp:HiddenField ID="txtHideTipoTarifa" runat="server" />
                </td>
                <td>
                    Monto<br />
                    <asp:TextBox ID="Monto" runat="server" Width="100px" ReadOnly="True">0</asp:TextBox>
                </td>
                <td>
                    Monto No Excede<br />
                    <asp:TextBox ID="MontoNoExceder" runat="server" Width="100px">0</asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="TipoTarifaOriginal" runat="server" Width="60px" Visible="false"></asp:TextBox>
                    <asp:HiddenField ID="txtHiddenNParte" runat="server" />
                    <asp:HiddenField ID="txtHiddenTTrabajo" runat="server" />
                </td>
            </tr>
        </table>
        <table cellpadding="5px"><%--BOTON  QUE CALCULA EN CASO DE MODIFICAR LA CANTIDAD U OTROS VALORES QUE AFECTEN EL MONTO --%>
            <tr>
                <td><asp:Button runat="server" ID="btnCalcula" Text="Calcular Equipo" Width="130px" /></td>
                <td><asp:Button runat="server" ID="btnAgrega" Text="Agregar Equipo" Width="130px" /></td>                        
            </tr>
        </table>
        <table>
            <tr>
        ...
        <ContentTemplate>
            <div id="contenedor">
                ...
                <div id="precioexcede">
                    <div class="tabla">
                        <div class="fila">
                            <div class="columna"><asp:Label ID="Label2" runat="server" Text="Label" Font-Bold="true">Precio Total Excede</asp:Label></div>
                            <div class="columna"></div>
                        </div>
                        <div class="fila">
                            <div class="columna">Neto Excede</div>
                            <div class="columna"><asp:TextBox ID="txtNetoExc" runat="server" Width="100px" 
                                    ReadOnly="True" style="text-align: right;">0</asp:TextBox></div>
                        </div>
                        <div class="fila">
                            <div class="columna">Descuento Excede</div>
                            <div class="columna"><asp:TextBox ID="txtDctoExc" runat="server" Width="100px" 
                                    Enabled="False" style="text-align: right;">0</asp:TextBox></div>
                        </div>
                        <div class="fila">
                            <div class="columna">Neto Dcto Excede</div>
                            <div class="columna"><asp:TextBox ID="txtNetoDctoExc" runat="server" Width="100px" 
                                    ReadOnly="True" style="text-align: right;">0</asp:TextBox></div>
                        </div>
                        <div class="fila">
                            <div class="columna">IVA Excede</div>
                            <div class="columna"><asp:TextBox ID="txtIvaExc" runat="server" Width="100px" 
                                    ReadOnly="True" style="text-align: right;">0</asp:TextBox></div>
                        </div>
                        <div class="fila">
                            <div class="columna">Total Excede</div>
                            <div class="columna"><asp:TextBox ID="txtTotalExc" runat="server" Width="100px" 
                                    ReadOnly="True" style="text-align: right;">0</asp:TextBox></div>
                        </div>
                    </div>
                </div>
    ...
    <asp:UpdatePanel ID="panelJefe" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtValidezOferta" runat="server"></asp:TextBox>
