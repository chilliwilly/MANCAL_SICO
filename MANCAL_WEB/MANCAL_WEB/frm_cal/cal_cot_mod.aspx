        ...
        <fieldset class="inline">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="cboBuscaCliCot" runat="server" OnInit="cboBuscaCliCot_Init" style="width:250px;" CssClass="_cboBuscaCliCot_">
                        </asp:DropDownList>
        ...
        <ContentTemplate>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td class="style9">
                        <input type="text" id="txtId_Cotizacion" name="txtId_Cotizacion" readonly="readonly" style="text-align:center;"/>
                    </td>
                </tr>
                <tr>
                    <td class="style5">
