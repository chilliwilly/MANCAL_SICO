<%@ Page Title="Calibraciones - Sistema Cotizacion" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cal_cot_mod.aspx.cs" Inherits="MANCAL_WEB.frm_cal.cal_cot_mod" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Modificación Cotización Calibraciones</h1>
...
<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnableScriptGlobalization="True" ScriptMode="Release" EnablePartialRendering="true" LoadScriptsBeforeUI="false">
    ...
    <asp:UpdatePanel ID="udpBotonBuscaCoti" runat="server" UpdateMode="Conditional" style="display:none;">
        <ContentTemplate>
            <asp:Button ID="btnBuscaCotizacion" runat="server" OnClick="btnBuscaCotizacion_Click"/>
        </ContentTemplate>
    </asp:UpdatePanel>

    <asp:UpdatePanel ID="udpBotonBuscaCotiL" runat="server" UpdateMode="Conditional" style="display:none;">
        <ContentTemplate>
            <asp:Button ID="btnBuscaCotizacionL" runat="server" OnClick="btnBuscaCotizacionL_Click" />
        </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <br /><br />
    <!-- CUADRO MUESTRA PARA BUSCAR COTIZACION -->
    <div id="dialog-busca-cot" title="Buscar Cotizacion" style="display:none;">        
        <fieldset class="inline">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="cboBuscaNroCot" runat="server" OnInit="cboBuscaNroCot_Init" CssClass="_cboBuscaNroCot_">
                        </asp:DropDownList>
                        <%--<select id="cboBuscaNroCot" name="cboBuscaNroCot"></select>--%>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:DropDownList ID="cboBuscaIdCot" runat="server" OnInit="cboBuscaIdCot_Init" CssClass="_cboBuscaIdCot_">
                        </asp:DropDownList>
                        <%--<select id="cboBuscaIdCot" name="cboBuscaIdCot"></select>--%>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:DropDownList ID="cboBuscaVendedor" runat="server" OnInit="cboBuscaVendedor_Init" CssClass="_cboBuscaVendedor_">
                        </asp:DropDownList>
                        <%--<select id="cboBuscaVendedor" name="cboBuscaVendedor"></select>--%>
                    </td>
                </tr>
            </table>
        </fieldset>
        ...
        <fieldset class="inline">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="cboBuscaEstadoCot" runat="server" OnInit="cboBuscaEstadoCot_Init" CssClass="_cboBuscaEstadoCot_">
                        </asp:DropDownList>
                        <%--<select id="cboBuscaEstadoCot" name="cboBuscaEstadoCot"></select>--%>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:DropDownList ID="cboBuscaCliCot" runat="server" OnInit="cboBuscaCliCot_Init" style="width:250px;" CssClass="_cboBuscaCliCot_" onactivate="maxWidth();" ondeactivate="restoreWidth();">
                        </asp:DropDownList>
                        <%--<select id="cboBuscaCliCot" name="cboBuscaCliCot"></select>--%>
                    </td>
                </tr>
                <tr>
                    <td></td>
        ...
        <asp:UpdatePanel ID="udpBuscaCotizacion" runat="server" UpdateMode="Conditional" OnLoad="upListaCotizacion_Load">
            <ContentTemplate>
                ...
                <asp:GridView ID="gvListaCotizacion" runat="server" AutoGenerateColumns="false"
                    ...
                    PagerSettings-LastPageText="Ultima" Width="1250px" HeaderStyle-HorizontalAlign="Center" RowStyle-HorizontalAlign="Left" Font-Size="Small"
                    onpageindexchanging="gvListaCotizacion_PageIndexChanging">
                    <RowStyle CssClass="gvCssListaCot" />
                    
                    <Columns>

                        <asp:TemplateField HeaderStyle-CssClass="ocultaCol" ItemStyle-CssClass="ocultaCol" HeaderText="Cot Numero">
                            <ItemTemplate>
                                <asp:Label ID="cot_numero" CssClass="cot_numero_" runat="server" Text='<%# Bind("COT_NUMERO") %>'></asp:Label>                                
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cotizacion" HeaderStyle-Width="100px">
                            <ItemTemplate>
                                <asp:Label ID="cot_id" CssClass="cot_id_" runat="server" Text='<%# Bind("COT_ID") %>'></asp:Label>                                
                            </ItemTemplate>
                        </asp:TemplateField>                        

                        <asp:TemplateField HeaderText="Fecha Cotizacion" HeaderStyle-Width="85px">
                            <ItemTemplate>
                                <asp:Label ID="cot_fecha" CssClass="cot_fecha_" runat="server" Text='<%# Bind("COT_FECHA") %>'></asp:Label>                                
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Estado" HeaderStyle-Width="130px">
                            <ItemTemplate>
                                <asp:Label ID="ec_id" CssClass="ec_id_" runat="server" Text='<%# Bind("EC_ID") %>'></asp:Label>                                
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Vendedor" HeaderStyle-Width="130px">
                            <ItemTemplate>
                                <asp:Label ID="ven_id" CssClass="ven_id_" runat="server" Text='<%# Bind("VEN_ID") %>'></asp:Label>                                
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cuenta" HeaderStyle-Width="300px">
                            <ItemTemplate>
                                <asp:Label ID="cot_cuentacli" CssClass="cot_cuentacli_" runat="server" Text='<%# Bind("COT_CUENTACLI") %>'></asp:Label>                                
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Contacto Nombre" HeaderStyle-Width="200px">
                            <ItemTemplate>
                                <asp:Label ID="cot_contacto_nom" CssClass="cot_contacto_nom_" runat="server" Text='<%# Bind("COT_CONTACTO_NOM") %>'></asp:Label>                                
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Contacto Fono">
                            <ItemTemplate>
                                <asp:Label ID="cot_contacto_ff" CssClass="cot_contacto_ff_" runat="server" Text='<%# Bind("COT_CONTACTO_FF") %>'></asp:Label>                                
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Contacto Mail">
                            <ItemTemplate>
                                <asp:Label ID="cot_contacto_mail" CssClass="cot_contacto_mail_" runat="server" Text='<%# Bind("COT_CONTACTO_MAIL") %>'></asp:Label>                                
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Total" HeaderStyle-CssClass="ocultaCol" ItemStyle-CssClass="ocultaCol">
                            <ItemTemplate>
                                <asp:Label ID="cot_total" CssClass="cot_total_" runat="server" Text='<%# Bind("COT_TOTAL") %>'></asp:Label>                                
                            </ItemTemplate>
                        </asp:TemplateField>

                        <%--<asp:TemplateField HeaderStyle-Width="30px">
                            <ItemTemplate>
                                <a href="javascript:void(null);" id="btn-ver-cot" onclick="mostrarDocCotizacion();" style="display:inline-block;" class="ui-icon ui-icon-print"></a>
                            </ItemTemplate>
                        </asp:TemplateField>--%>

                        <asp:TemplateField HeaderText="" HeaderStyle-Width="30px">
                            <ItemTemplate>
                                <a href="javascript:void(null);" id="btn-select-cot" onclick="seleccionaNumCotiz();" style="display:inline-block;" class="ui-icon ui-icon-check"></a>                                
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <ContentTemplate>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td class="style6">
                        <asp:DropDownList ID="cboEstadoCotizacion" runat="server" Width="263px" CssClass="_cboEstadoCotizacion_"
                            oninit="cboEstadoCotizacion_Init"> 
                        </asp:DropDownList>
                    </td>
                    <td class="style9">
                    </td>
                    ...
                    <td class="style9">
                        <input type="text" id="txtId_Cotizacion" name="txtCotizacionText" value="" readonly="readonly" style="text-align:center;"/>
                    </td>
                </tr>
                <tr>
                    <td class="style5">
                    ...
                    <td class="style9">
                        <asp:TextBox ID="txtIdCotizacion" CssClass="_txtIdCotizacion_" runat="server" Width="130px" ReadOnly="True" style="display:none;"></asp:TextBox>                        
                ...
                <tr>
                    ...
                    <td class="style6">
                        ...
                        <input type="text" id="txt_Fecha" name="txt_Fecha" style="display:none;"/>
        ...
        <ContentTemplate>
            <table style="font-weight:bold;">
                <tr>
                    <td>Nro Caso</td>
                    <td>
                        <input type="text" id="txtNroCaso" name="txtNroCaso" readonly="readonly" style="width:120px; text-align:center;"/>
                    </td>
                    <td rowspan="3" valign="top">NP Caso</td>
                    <td rowspan="3" valign="top">
                        <asp:TextBox ID="txtNPCaso" runat="server" CssClass="_txtNPCaso_" ReadOnly="true" Height="40px"
                ...
                <tr>
                    <td>VA Caso</td>
                    <td>
                        <input type="text" id="txtVaCaso" name="txtVaCaso" readonly="readonly" style="width:120px; text-align:center;"/>
                    </td>
                </tr>
                <tr>
                    <td>Total Caso</td>
                    <td>
                        <input type="text" id="txtTotalCaso" name="txtTotalCaso" readonly="readonly" style="width:120px; text-align:center;"/>
                    </td>
                </tr>
            </table>
        </ContentTemplate>
    ...
    <table cellpadding="5px">
        <tr>
            ...
            <td>
                <input type="button" id="btn-ver-cot" value="Imprimir" onclick="mostrarDocCotizacion();" />
            </td>
        </tr>
      </table>
    ...
    <script type="text/javascript">
        ...
        $("#btn-busca-cot").on('click', function () {
            ...
            $.cookie('_dataCN', '');
            $.cookie('_dataCT', '');
            $("#<%=btnBuscaCotizacion.ClientID %>").click();
            $("#dialog-busca-cot").dialog({
                modal: true,
                width: "1300px",
                buttons: {
                    "Buscar": function () {
                        $.cookie('_dataV', $('._cboBuscaVendedor_').val());
                        $.cookie('_dataEC', $('._cboBuscaEstadoCot_').val());
                        $.cookie('_dataC', $('._cboBuscaCliCot_').val());
                        $.cookie('_dataCN', $('._cboBuscaNroCot_').val());
                        $.cookie('_dataCT', $('._cboBuscaIdCot_').val());
                        $("#<%=btnBuscaCotizacion.ClientID %>").click();
                    },
                    "Cerrar": function () {
                        $(this).dialog('close');
                        $.removeCookie('_dataV');
                        $.removeCookie('_dataEC');
                        $.removeCookie('_dataC');
                        $.removeCookie('_dataCN');
                        $.removeCookie('_dataCT');
                        $("#<%=btnBuscaCotizacionL.ClientID %>").click();
                        $("#dialog-busca-cot").dialog("destroy");
                    }
                }
            });
        });

        function seleccionaNumCotiz() {//SELECCIONA EL NUMERO DEL GRID DE COTIZACIONES BUSCADAS
            //alert("Busca Cotizacion");            
            $('.gvCssListaCot').on('click', function () {
                seleccionaCotizacion($('.cot_numero_', $(this).closest('tr')).html());
            });            
        }

        function mostrarDocCotizacion() {
            //alert("Imprime COtizacion");
            verDocCotizacion($('._txtIdCotNum_').val(), $('._txtIdCotTxt_').val());
        }

        /*************************/
        //inicio scripts cotizacion
        $.cookie('nomclient', '');
        $.cookie('nomcuenta', '');
        $.cookie('nomcontact', '');
        $.cookie('nomtipo', '');
        ...
        function delDetalleArch() {
            $('.gvArchivoDet').on('click', function () {
                ...
                arch_idcoti = $.cookie("txtcot"); //pccookie $('.adj_cotid', $(this).closest('tr')).html();
            });
        }
        ...
        function maxWidth() {
            var maxlength = 0;
            var mySelect = document.getElementById('cboBuscaCliCot');
